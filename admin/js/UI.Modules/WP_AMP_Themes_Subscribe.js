function WP_AMP_THEMES_SUBSCRIBE() {
    ...
    jQuery.ajax({
      ...
      success: function (responseJSON) {
        ...
        if (response === 1) {
          ...
          WATJSInterface.Loader.display({ message: 'Your subscription has been confirmed.' });
      ...
      error: function() {
        WATJSInterface.Preloader.remove(100);
        WATJSInterface.Loader.display({ message: 'There was an error. Please reload the page and try again in few seconds or contact the plugin administrator if the problem persists.' });
      }
    });
  };
